    ...
    public class MovieMVCContext : IdentityDbContext<MovieMVCUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Post>().HasData(
               ...
               new Post {Id = 10,Title = "Goodfellas", Description = "The story of Henry Hill and his life in the mob, covering his relationship with his wife Karen Hill and his mob partners Jimmy Conway and Tommy DeVito in the Italian-American crime syndicate.", Status = "Published",CreatedAt = DateTime.Now,ReleaseDate = "1990-11-02",ImagePost = "https://adambergaoui.files.wordpress.com/2016/11/goodfellas.jpg?w=860", CategoryId = 6 });
